...
public partial class VwBookingFormTracking
{
    ...
    public string? FileReceivingFileNo { get; set; }
    ...
    public string? EmployeeSubSegmentName { get; set; }
    ...
    public string? ConfReceiptNo { get; set; }

    public string? InstReceiptNo { get; set; }
}
