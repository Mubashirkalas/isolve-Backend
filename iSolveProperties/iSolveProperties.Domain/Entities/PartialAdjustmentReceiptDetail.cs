...
public partial class PartialAdjustmentReceiptDetail
{
    ...
    public string? ChequesNewSrno { get; set; }

    public virtual Bank? Bank { get; set; }

    public virtual BusinessPartnersMain? BusinessPartnersMain { get; set; }

    public virtual ChequesClearing? ChequesClearing { get; set; }

    public virtual PartialAdjustment PartialAdjustment { get; set; } = null!;
}
